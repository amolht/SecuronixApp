...
</code></pre><p>Then <code>npm update</code> will install <a href="mailto:`dep1@1.2.2">`dep1@1.2.2</a><code>, because</code>1.2.2<code>is</code>latest<code>and
`1.2.2` satisfies</code>^1.1.1`.</p>
...
</code></pre><p>Then <code>npm update --save</code> will install <a href="mailto:`dep1@1.2.2">`dep1@1.2.2</a><code>(i.e.,</code>latest<code>),
and</code>package.json` will be modified:</p>
<pre><code>&quot;dependencies&quot;: {
  &quot;dep1&quot;: &quot;^1.2.2&quot;
}
...
<p id="footer">npm-update &mdash; npm@5.7.0</p>
